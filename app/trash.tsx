...
export default function UploadSurvey() {
  ...
  <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-md p-6 sm:p-10 mb-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            <Image src="/SurveyHustler Logo.png" alt="SurveyHustler Logo" width={40} height={40} />
      ...
      <div className="max-w-4xl mx-auto mt-6 flex justify-center">
        <button
          className="w-[90%] sm:w-[90%] bg-yellow-700 hover:bg-yellow-800 text-white px-6 py-3 rounded-md flex items-center justify-center space-x-2 transition duration-200"
        >
          <span>Next</span>
          <svg
